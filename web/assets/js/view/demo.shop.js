...
function _shop() {
    ...
    **/
    ...
    $("#account_type").change(function() {
        var home = $("#form-hidden-part .type-home");
        var business = $("#form-hidden-part .type-business");
        var home_block = $("#register-form .type-home");
        var business_block = $("#register-form .type-business");
        var hidden = $("#form-hidden-part");
        var btn = $("#register-form button");
        console.log(home)
        if ($("#account_type").val() == "") {
            hidden.append(home_block);
            hidden.append(business_block);
            home_block.css("display", "none");
            business_block.css("display", "none");
        } else if ($("#account_type").val() == "Home") {
            btn.before(home);
            home.css("display", "block");
            hidden.append(business_block);
            business_block.css("display", "none");
        } else if ($("#account_type").val() == "Business") {
            btn.before(business);
