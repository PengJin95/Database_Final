        ...
        <div id="wrapper">
            ...
            <section>
                <div class="container">
                    ...
                    <!-- EMPTY CART -->
                    <div class="mb-60 box-border-shadow p-20 empty-cart">
                        <strong>Shopping cart is empty!</strong><br />
                        You have no items in your shopping cart.<br />
                        Click <a href="index.jsp">here</a> to continue shopping. <br />
                    </div>
                    <!-- /EMPTY CART -->
                        ...
                        <div class="col-lg-9 col-sm-8">
                            ...
                            <form class="cartContent clearfix">
                                ...
                                <div id="cartContent">
                                    ...
                                    <div class="box-border-shadow cart-item-list">
                                    ...
                                    <!-- update cart -->
                                    <button type="button" id="update-cart" class="btn btn-success btn-sm mt-20 ml-10 float-right"><i class="glyphicon glyphicon-ok"></i> UPDATE CART</button>
                                    <!-- /update cart -->
                            ...
                            <div class="toggle-transparent toggle-bordered-full clearfix">
                                <div class="toggle active">
                                    <div class="toggle-content">
                                        ...
                                        <span class="clearfix">
                                            <span class="float-right total-to-checkout">$0.00</span>
                                        ...
                                        <span class="clearfix">
                                            <span class="float-right fs-20 total-to-checkout">$0.00</span>
                                            <strong class="float-left">TOTAL:</strong>
                                        </span>

                                        <hr />

                                        <button type="button" id="proceed-to-checkout" class="btn btn-primary btn-lg btn-block fs-15" onclick="window.location.href = 'checkout.jsp'"><i class="fa fa-mail-forward"></i> Proceed to Checkout</button>
                                    </div>
                                </div>
                            </div>
