        ...
        <nav id="header" class="header-light header-fixed header-shadow-1">
            <div class="container">
                ...
                <a class="header-logo" href="index.jsp">
                    <img src="demo_files/pj/logo.png" height="60" alt="">
                </a>
                ...
                <div class="container">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="side-custom-content float-left mt-0">
                            ...
                            <h2 class="fs-16 font-regular mb-20 mt-6 text-primary">
                                ORDER No. <%=request.getParameter("oid")%>
                                <span class="block fs-14">
                                    <%=request.getParameter("otime")%>
                                </span>
                            </h2>
                            ...
                            <div class="row ml-0 mrad-0 order-infomation">
                            ...
                            <div class="table-responsive mt-60">
                                ...
                                <table class="table table-bordered fs-16 fw-400">
                                    <thead class="fs-14">
                                        <tr>
                                            <th class="fw-600">BOOK TITLE</th>
                                            <th class="fw-600">ISBN</th>
                                            <th class="fw-600">AMOUNT</th>
                                            <th class="fw-600">UNIT PIRCE</th>
                                            <th class="fw-600">TOTAL PIRCE</th>
