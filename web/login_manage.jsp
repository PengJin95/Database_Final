...
<html lang="en">
    ...
    <body class="smoothscroll enable-animation">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 offset-md-3 col-sm-8 offset-sm-2">
                            ...
                            <form class="box-border-shadow p-20" method="post" action="#">
                                ...
                                <input type="hidden">
                                <button type="button" class="btn btn-primary btn-v1 float-left mt-8 inline-block" tabindex="3" id="submit-btn" disabled="true">SIGN IN</button>
            ...
            <div class="container pt-0 pb-0">
                ...
                <div class="row mt-60 mb-0 fs-13">
                    ...
                    <div class="col-md-4 col-sm-4 mb-0">
                        ...
                        <!-- Footer Logo -->
                        <img class="footer-logo" src="demo_files/images/packs/megashop/logo_dark_footer.png" alt="" />
                        ...
                        <div class="clearfix">
                            ...
                            <a href="#" class="social-icon social-icon-sm social-icon-border social-facebook float-left" data-toggle="tooltip" data-placement="top"
                               title="Facebook">
                                <i class="icon-facebook"></i>
                                <i class="icon-facebook"></i>
                            </a>

                            <a href="#" class="social-icon social-icon-sm social-icon-border social-twitter float-left" data-toggle="tooltip" data-placement="top"
                               title="Twitter">
                                <i class="icon-twitter"></i>
                                <i class="icon-twitter"></i>
                            </a>

                            <a href="#" class="social-icon social-icon-sm social-icon-border social-gplus float-left" data-toggle="tooltip" data-placement="top"
                               title="Google plus">
                                <i class="icon-gplus"></i>
                                <i class="icon-gplus"></i>
                            </a>

                            <a href="#" class="social-icon social-icon-sm social-icon-border social-linkedin float-left" data-toggle="tooltip" data-placement="top"
                               title="Linkedin">
                                <i class="icon-linkedin"></i>
                                <i class="icon-linkedin"></i>
                            </a>

                            <a href="#" class="social-icon social-icon-sm social-icon-border social-pinterest float-left" data-toggle="tooltip" data-placement="top"
                               title="Rss">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 hidden-sm hidden-xs-down">
                                ...
                                <ul class="list-unstyled footer-list half-paddings b-0">
                                    ...
                                    <li>
                                        <a class="block" href="#">
                                            <i class="fa fa-angle-right"></i> Making Payments</a>
                                    </li>
                                    <li>
                                        <a class="block" href="#">
                                            <i class="fa fa-angle-right"></i> New User Guide</a>
                                    </li>
                                    <li>
                                        <a class="block" href="#">
                                            <i class="fa fa-angle-right"></i> Buyer Protection</a>
                                    </li>
                                    <li>
                                        <a class="block" href="#">
                                            <i class="fa fa-angle-right"></i> Delivery Options</a>
                                    </li>
                                    <li>
                                        <a class="block" href="#">
                                            <i class="fa fa-angle-right"></i> Partnerships</a>
                                    </li>
                                    <li>
                                        <a class="block" href="#">
                                            <i class="fa fa-angle-right"></i> Affiliate Program</a>
                                    </li>
                                </ul>
                            </div>
        ...
        <script type="text/javascript" src="assets/js/login_manage.js"></script>
