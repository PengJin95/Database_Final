                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            ...
                            <!-- CAROUSEL -->
                            <div class="owl-carousel buttons-autohide controlls-over mb-30 radius-4" data-plugin-options='{"singleItem": true, "autoPlay": false, "navigation": true, "pagination": true, "transitionStyle":"fade"}'>
                                <!-- item -->
                                <div>
                                        ...
                                        <div class="display-table">
                                            <div class="display-table-cell vertical-align-middle">
                                                <div class="caption-container text-left">
                                                    <h2 style="font-weight: 400">SHOP NOW &ndash; 30% OFF</h2>
                                                    <h3 style="font-weight: 300">
                                                        From 12/1/2017 to 1/7/2018<br/> (Certain Books)
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <img class="img-fluid radius-4" src="demo_files/pj/christmas-sm-light.jpg" width="851" height="335" alt="">
                                </div>
                                <!-- /item -->
                            ...
                            <div class="clearfix shop-list-options mb-20">
                                ...
                                <div class="options-left">
                                    ...
                                    <span class="ml-10">Sort By:</span>
                                    <select class="rerank-order">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            ...
                            <div class="side-nav mb-60">
                                ...
                                <ul class="list-group list-group-bordered list-group-noicon uppercase result-categories">
                                    ...
                                    <div>
                                        ...
                                        <ul class="list-unstyled m-0 p-0 text-left">
                                            ...
                                            <li class="clearfix">
                                                ...
                                                <div class="thumbnail featured clearfix float-left">
                                                    <a href="#">
                                                        <img src="demo_files/pj/3.jpg" width="80" alt="featured item">
                                                    </a>
                                                </div>
                                            ...
                                            <li class="clearfix">
                                                ...
                                                <div class="thumbnail featured clearfix float-left">
                                                    <a href="#">
                                                        <img src="demo_files/pj/4.jpg" width="80" alt="featured item">
                                                    </a>
                                                </div>
                                            ...
                                            <li class="clearfix">
                                                ...
                                                <div class="thumbnail featured clearfix float-left">
                                                    <a href="#">
                                                        <img src="demo_files/pj/5.jpg" width="80" alt="featured item">
                                                    </a>
                                                </div>
